...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 15 août 2025 à 09:19
...
--
-- Base de données : `starv-roleplay`
--
...
--
-- Index pour la table `epyi_administration`
--
ALTER TABLE `epyi_administration`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT pour la table `epyi_administration`
--
ALTER TABLE `epyi_administration`
