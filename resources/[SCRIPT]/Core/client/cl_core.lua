...
Citizen.CreateThread(function()
    ...
    AddTextEntry('FE_THDR_GTAO', 'ZP Base Template - ~b~ZJ Developpement~s~ | ID : ' .. id .. ' | Nom : ' .. name )
...
RegisterCommand("cco", function(source, args, rawCommand)
    -- Récupère le joueur (client-side)
    ...
    -- Copie dans le presse-papiers (nécessite nui)
    SendNUIMessage({
