...
CreateThread(function()
    for i, coords in ipairs(Config.Pos) do
    ...
    lib.zones.sphere({
        ...
        onEnter = function()
            inZone = true
            lib.showTextUI('[E] - ' .. Config.all.title, {
    ...
    CreateThread(function()
        while true do
            ...
            if Config.ShowBlips then
                ...
                SetBlipSprite(blip, Config.Blip.shop) -- Magasin
                SetBlipDisplay(blip, Config.Blip.affichage)
                SetBlipScale(blip, Config.Blip.tailleshop)
                SetBlipColour(blip, Config.Blip.couleurshop)
